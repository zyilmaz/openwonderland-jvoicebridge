...
public class GatewayManager {
    ...
    public static String getVoIPGatewayLoginInfo(InetSocketAddress addr) {
        for (int i = 0; i < voIPGateways.size(); i++) {
            if (addr.equals(voIPGateways.get(i))) {
                return voIPGatewayLoginInfo.get(i);
            }
        }
        
        Logger.println("No login info found for " + addr);
        return null;
    }
