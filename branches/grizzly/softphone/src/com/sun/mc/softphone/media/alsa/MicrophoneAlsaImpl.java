 ...
 */
public class MicrophoneAlsaImpl implements Microphone {
     ...
     * Constructors.
     */
    public MicrophoneAlsaImpl(int sampleRate, int channels,
	...
	audioDriver.initializeMicrophone(sampleRate, channels, bufferSize);
    }
	...
	readMicrophone(buf, 0, blueToothLen);
		...
		+ " for BlueTooth microphone");
		    ...
		    "Alsa Mic", 8000, 2, sampleRate, channels);
            } catch (IOException e) {
