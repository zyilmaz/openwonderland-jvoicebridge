...
public class IncomingConferenceHandler extends Thread 
    ...
    private static final String INVALID_PASS_CODE = "badcode.au";
    ...
    private static final String CALLER_NUMBER = "you-are-caller-num.au";
	...
	if (passCode.length() > 0) {
        ...
        try {
            ...
            System.err.println("Exception joining meeting! "
                + meetingCode + " " + e.getMessage());
