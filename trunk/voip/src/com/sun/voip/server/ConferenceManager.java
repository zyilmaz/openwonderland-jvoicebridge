...
public class ConferenceManager {
	...
	if (distributedBridge != null) {
		...
		Logger.println("conferenceEventNotification exception:  "
		    + e.getMessage());
		e.printStackTrace();
	    }
	}
	...
	synchronized (this) {
		...
		ConferenceEvent event = new ConferenceEvent(
		    ConferenceEvent.MEMBER_LEFT, conferenceId);
    ...
    private static ConferenceManager findConferenceManager(
	...
	ConferenceManager.conferenceEventNotification(
	    new ConferenceEvent(ConferenceEvent.CONFERENCE_STARTED, id));
